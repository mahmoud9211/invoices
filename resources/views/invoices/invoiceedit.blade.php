...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="Amount_collection" value="{{$data->Amount_collection}}" >
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="Amount_Commission" name="Amount_Commission" value="{{$data->Amount_Commission}}" >
...
<div class="form-group">
    <label>الخصم</label>
    <input type="text" class="form-control" id="Discount" value="0" name="Discount" value="{{$data->Discount}}">
  </div>
</div>
