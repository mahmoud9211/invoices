                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td class="tx-12">{{ $data->products->product_name }}</td>
                                        <td class="tx-center">{{ number_format($data->Amount_collection, 2) }}</td>
                                        <td class="tx-right">{{ number_format($data->Amount_Commission, 2) }}</td>
                                        @php
                                        $total = $data->Amount_collection + $data->Amount_Commission ;
                                        @endphp
                                        <td class="tx-right">
                                    ...
                                    <tr>
                                        <td class="tx-right">نسبة الضريبة ({{ $data->Rate_VAT }})</td>
