...
<label class="rdiobox"><input name="rdio" value="2" type="radio" id="type_div2"><span>بحث برقم الفاتورة
</span></label>
</div><br><br>
...
<div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_num">
...
<td>
    @can('تفاصيل الفاتوره')
    <a href="{{ route('invoices.det',$invoice->id) }}">{{ $invoice->products->product_name }}
    </a>
    @endcan
    </td>
<td>
